...
/*
 * Variable RTU_Temp	[ Sensor temperature in °C ]
 */
...
/*
 * Variable RTU_HR	[ Relative Humidity in % ]
 */
...
/*
 * Variable RTU_CO2_ppm	[ ppm Co2 concentration ]
 */

u_int16_t RTU_CO2_ppm = 0;


/*
 * Variable RTU_O3	[ Part per billion O3 concentration ]
 */
...
/*
 * Variable RTU_C_PM1_0	[ PM 1.0 ug-m3  range 0-1000 ]
 */

u_int16_t RTU_C_PM1_0 = 0;


/*
 * Variable RTU_C_PM2_5	[ PM 2.5 ug-m3  range 0-1000 ]
 */

u_int16_t RTU_C_PM2_5 = 0;


/*
 * Variable RTU_C_PM4_0	[ PM 4.0 ug-m3  range 0-1000 ]
 */

u_int16_t RTU_C_PM4_0 = 0;


/*
 * Variable RTU_C_PM10	[ PM 10 ug-m3  range 0-1000 ]
 */

u_int16_t RTU_C_PM10 = 0;


/*
 * Variable C_BitMaskLoT1	[ Low part bitmask ]
 */
...
/*
 * Variable C_itMaskLoHR1	[ Low part bitmask ]
 */
...
/*
 * Variable C_BitMaskLoCO21	[ Low part bitmask ]
 */

int C_BitMaskLoCO21 = 0;


/*
 * Variable C_BitMaskLoO31	[ Low part bitmask ]
 */

int C_BitMaskLoO31 = 0;


/*
 * Variable C_BitMaskLoVOC1	[ Low part bitmask ]
 */

int C_BitMaskLoVOC1 = 0;


/*
 * Variable C_BitMaskLoPM251	[ Low part bitmask ]
 */

int C_BitMaskLoPM251 = 0;


/*
 * Variable C_BitMaskLoCH41	[ Low part bitmask ]
 */

int C_BitMaskLoCH41 = 0;


/*
 * Variable C_BitMaskHi1	[ Hi part bitmask ]
 */

u_int16_t C_BitMaskHi1 = 0;


/*
 * Variable C_HeartBeatLo	[ Heart beat low part update each 100ms ]
 */

u_int16_t C_HeartBeatLo = 0;


/*
 * Variable C_READS	[ Heart beat low part update each 100ms ]
 */
...
/*
 * Variable Mirror_Temp	[ Sensor temperature in °C ]
 */

int16_t Mirror_Temp = 0;


/*
 * Variable Mirror_HR	[ Relative Humidity in % ]
 */

u_int16_t Mirror_HR = 0;


/*
 * Variable Mirror_CO2_ppm	[ ppm Co2 concentration ]
 */

u_int16_t Mirror_CO2_ppm = 0;


/*
 * Variable Mirror_O3	[ Part per billion O3 concentration ]
 */

u_int16_t Mirror_O3 = 0;


/*
 * Variable Mirror_VOC	[ VOC measure ]
 */

u_int16_t Mirror_VOC = 0;


/*
 * Variable Mirror_C_PM2_5	[ PM 2.5 ug-m3  range 0-1000 ]
 */

u_int16_t Mirror_C_PM2_5 = 0;


/*
 * Variable Mirror_CH4	[ Average partcle diameter ]
 */

u_int16_t Mirror_CH4 = 0;


/*
 * Variable Mirror_TempFirst
 */

int16_t Mirror_TempFirst = 0;


/*
 * Variable Mirror_TempSecond
 */

int16_t Mirror_TempSecond = 0;


/*
 * Variable Mirror_TempThird
 */

int16_t Mirror_TempThird = 0;


/*
 * Variable Mirror_TempFourth
 */

int16_t Mirror_TempFourth = 0;


/*
 * Variable C_Mirror_Temp	[ Sensor temperature in °C ]
 */

int16_t C_Mirror_Temp = 0;


/*
 * Variable C_Mirror_HR	[ Relative Humidity in % ]
 */

u_int16_t C_Mirror_HR = 0;


/*
 * Variable C_Mirror_CO2_ppm	[ ppm Co2 concentration ]
 */

u_int16_t C_Mirror_CO2_ppm = 0;


/*
 * Variable C_Mirror_O3	[ Part per billion O3 concentration ]
 */

u_int16_t C_Mirror_O3 = 0;


/*
 * Variable C_Mirror_VOC	[ VOC measure ]
 */

u_int16_t C_Mirror_VOC = 0;


/*
 * Variable C_Mirror_C_PM2_5	[ PM 2.5 ug-m3  range 0-1000 ]
 */

u_int16_t C_Mirror_C_PM2_5 = 0;


/*
 * Variable CommandCO2	[ PM 2.5 ug-m3  range 0-1000 ]
 */

u_int16_t CommandCO2 = 0;
...
int
doWrite_TCP_RTU(u_int16_t value)
{
	return doWrite(ID_TCP_RTU, &value);
}

int
addWrite_TCP_RTU(u_int16_t value)
{
	return addWrite(ID_TCP_RTU, &value);
}

int
getStatus_TCP_RTU(void)
{
	return getStatus(ID_TCP_RTU);
}

int
doWrite_RTU_Temp(int16_t value)
{
	return doWrite(ID_RTU_Temp, &value);
}

int
addWrite_RTU_Temp(int16_t value)
{
	return addWrite(ID_RTU_Temp, &value);
}

int
getStatus_RTU_Temp(void)
{
	return getStatus(ID_RTU_Temp);
}

int
doWrite_RTU_HR(u_int16_t value)
{
	return doWrite(ID_RTU_HR, &value);
}

int
addWrite_RTU_HR(u_int16_t value)
{
	return addWrite(ID_RTU_HR, &value);
}

int
getStatus_RTU_HR(void)
{
	return getStatus(ID_RTU_HR);
}

int
doWrite_RTU_CO2_ppm(u_int16_t value)
{
	return doWrite(ID_RTU_CO2_ppm, &value);
}

int
addWrite_RTU_CO2_ppm(u_int16_t value)
{
	return addWrite(ID_RTU_CO2_ppm, &value);
}

int
getStatus_RTU_CO2_ppm(void)
{
	return getStatus(ID_RTU_CO2_ppm);
}

int
doWrite_RTU_O3(u_int16_t value)
{
	return doWrite(ID_RTU_O3, &value);
}

int
addWrite_RTU_O3(u_int16_t value)
{
...
int
doWrite_RTU_VOC(u_int16_t value)
{
	return doWrite(ID_RTU_VOC, &value);
}

int
addWrite_RTU_VOC(u_int16_t value)
{
...
int
doWrite_RTU_C_PM1_0(u_int16_t value)
{
	return doWrite(ID_RTU_C_PM1_0, &value);
}

int
addWrite_RTU_C_PM1_0(u_int16_t value)
{
	return addWrite(ID_RTU_C_PM1_0, &value);
}

int
getStatus_RTU_C_PM1_0(void)
{
	return getStatus(ID_RTU_C_PM1_0);
}

int
doWrite_RTU_C_PM2_5(u_int16_t value)
{
	return doWrite(ID_RTU_C_PM2_5, &value);
}

int
addWrite_RTU_C_PM2_5(u_int16_t value)
{
	return addWrite(ID_RTU_C_PM2_5, &value);
}

int
getStatus_RTU_C_PM2_5(void)
{
	return getStatus(ID_RTU_C_PM2_5);
}

int
doWrite_RTU_C_PM4_0(u_int16_t value)
{
	return doWrite(ID_RTU_C_PM4_0, &value);
}

int
addWrite_RTU_C_PM4_0(u_int16_t value)
{
	return addWrite(ID_RTU_C_PM4_0, &value);
}

int
getStatus_RTU_C_PM4_0(void)
{
	return getStatus(ID_RTU_C_PM4_0);
}

int
doWrite_RTU_C_PM10(u_int16_t value)
{
	return doWrite(ID_RTU_C_PM10, &value);
}

int
addWrite_RTU_C_PM10(u_int16_t value)
{
	return addWrite(ID_RTU_C_PM10, &value);
}

int
getStatus_RTU_C_PM10(void)
{
	return getStatus(ID_RTU_C_PM10);
}

int
doWrite_C_BitMaskLoT1(int value)
{
	return doWrite(ID_C_BitMaskLoT1, &value);
}

int
addWrite_C_BitMaskLoT1(int value)
{
	return addWrite(ID_C_BitMaskLoT1, &value);
}

int
getStatus_C_BitMaskLoT1(void)
{
	return getStatus(ID_C_BitMaskLoT1);
}

int
doWrite_C_itMaskLoHR1(int value)
{
	return doWrite(ID_C_itMaskLoHR1, &value);
}

int
addWrite_C_itMaskLoHR1(int value)
{
	return addWrite(ID_C_itMaskLoHR1, &value);
}

int
getStatus_C_itMaskLoHR1(void)
{
	return getStatus(ID_C_itMaskLoHR1);
}

int
doWrite_C_BitMaskLoCO21(int value)
{
	return doWrite(ID_C_BitMaskLoCO21, &value);
}

int
addWrite_C_BitMaskLoCO21(int value)
{
	return addWrite(ID_C_BitMaskLoCO21, &value);
}

int
getStatus_C_BitMaskLoCO21(void)
{
	return getStatus(ID_C_BitMaskLoCO21);
}

int
doWrite_C_BitMaskLoO31(int value)
{
	return doWrite(ID_C_BitMaskLoO31, &value);
}

int
addWrite_C_BitMaskLoO31(int value)
{
	return addWrite(ID_C_BitMaskLoO31, &value);
}

int
getStatus_C_BitMaskLoO31(void)
{
	return getStatus(ID_C_BitMaskLoO31);
}

int
doWrite_C_BitMaskLoVOC1(int value)
{
	return doWrite(ID_C_BitMaskLoVOC1, &value);
}

int
addWrite_C_BitMaskLoVOC1(int value)
{
	return addWrite(ID_C_BitMaskLoVOC1, &value);
}

int
getStatus_C_BitMaskLoVOC1(void)
{
	return getStatus(ID_C_BitMaskLoVOC1);
}

int
doWrite_C_BitMaskLoPM251(int value)
{
	return doWrite(ID_C_BitMaskLoPM251, &value);
}

int
addWrite_C_BitMaskLoPM251(int value)
{
	return addWrite(ID_C_BitMaskLoPM251, &value);
}

int
getStatus_C_BitMaskLoPM251(void)
{
	return getStatus(ID_C_BitMaskLoPM251);
}

int
doWrite_C_BitMaskLoCH41(int value)
{
	return doWrite(ID_C_BitMaskLoCH41, &value);
}

int
addWrite_C_BitMaskLoCH41(int value)
{
	return addWrite(ID_C_BitMaskLoCH41, &value);
}

int
getStatus_C_BitMaskLoCH41(void)
{
	return getStatus(ID_C_BitMaskLoCH41);
}

int
doWrite_C_BitMaskHi1(u_int16_t value)
{
	return doWrite(ID_C_BitMaskHi1, &value);
}

int
addWrite_C_BitMaskHi1(u_int16_t value)
{
	return addWrite(ID_C_BitMaskHi1, &value);
}

int
getStatus_C_BitMaskHi1(void)
{
	return getStatus(ID_C_BitMaskHi1);
}

int
doWrite_C_HeartBeatLo(u_int16_t value)
{
	return doWrite(ID_C_HeartBeatLo, &value);
}

int
addWrite_C_HeartBeatLo(u_int16_t value)
{
	return addWrite(ID_C_HeartBeatLo, &value);
}

int
getStatus_C_HeartBeatLo(void)
{
	return getStatus(ID_C_HeartBeatLo);
}

int
doWrite_C_READS(u_int32_t value)
{
	return doWrite(ID_C_READS, &value);
}

int
addWrite_C_READS(u_int32_t value)
{
	return addWrite(ID_C_READS, &value);
}

int
getStatus_C_READS(void)
{
	return getStatus(ID_C_READS);
}

int
doWrite_Mirror_Temp(int16_t value)
{
	return doWrite(ID_Mirror_Temp, &value);
}

int
addWrite_Mirror_Temp(int16_t value)
{
	return addWrite(ID_Mirror_Temp, &value);
}

int
getStatus_Mirror_Temp(void)
{
	return getStatus(ID_Mirror_Temp);
}

int
doWrite_Mirror_HR(u_int16_t value)
{
	return doWrite(ID_Mirror_HR, &value);
}

int
addWrite_Mirror_HR(u_int16_t value)
{
	return addWrite(ID_Mirror_HR, &value);
}

int
getStatus_Mirror_HR(void)
{
	return getStatus(ID_Mirror_HR);
}

int
doWrite_Mirror_CO2_ppm(u_int16_t value)
{
	return doWrite(ID_Mirror_CO2_ppm, &value);
}

int
addWrite_Mirror_CO2_ppm(u_int16_t value)
{
	return addWrite(ID_Mirror_CO2_ppm, &value);
}

int
getStatus_Mirror_CO2_ppm(void)
{
	return getStatus(ID_Mirror_CO2_ppm);
}

int
doWrite_Mirror_O3(u_int16_t value)
{
	return doWrite(ID_Mirror_O3, &value);
}

int
addWrite_Mirror_O3(u_int16_t value)
{
	return addWrite(ID_Mirror_O3, &value);
}

int
getStatus_Mirror_O3(void)
{
	return getStatus(ID_Mirror_O3);
}

int
doWrite_Mirror_VOC(u_int16_t value)
{
	return doWrite(ID_Mirror_VOC, &value);
}

int
addWrite_Mirror_VOC(u_int16_t value)
{
	return addWrite(ID_Mirror_VOC, &value);
}

int
getStatus_Mirror_VOC(void)
{
	return getStatus(ID_Mirror_VOC);
}

int
doWrite_Mirror_C_PM2_5(u_int16_t value)
{
	return doWrite(ID_Mirror_C_PM2_5, &value);
}

int
addWrite_Mirror_C_PM2_5(u_int16_t value)
{
	return addWrite(ID_Mirror_C_PM2_5, &value);
}

int
getStatus_Mirror_C_PM2_5(void)
{
	return getStatus(ID_Mirror_C_PM2_5);
}

int
doWrite_Mirror_CH4(u_int16_t value)
{
	return doWrite(ID_Mirror_CH4, &value);
}

int
addWrite_Mirror_CH4(u_int16_t value)
{
	return addWrite(ID_Mirror_CH4, &value);
}

int
getStatus_Mirror_CH4(void)
{
	return getStatus(ID_Mirror_CH4);
}

int
doWrite_Mirror_TempFirst(int16_t value)
{
	return doWrite(ID_Mirror_TempFirst, &value);
}

int
addWrite_Mirror_TempFirst(int16_t value)
{
	return addWrite(ID_Mirror_TempFirst, &value);
}

int
getStatus_Mirror_TempFirst(void)
{
	return getStatus(ID_Mirror_TempFirst);
}

int
doWrite_Mirror_TempSecond(int16_t value)
{
	return doWrite(ID_Mirror_TempSecond, &value);
}

int
addWrite_Mirror_TempSecond(int16_t value)
{
	return addWrite(ID_Mirror_TempSecond, &value);
}

int
getStatus_Mirror_TempSecond(void)
{
	return getStatus(ID_Mirror_TempSecond);
}

int
doWrite_Mirror_TempThird(int16_t value)
{
	return doWrite(ID_Mirror_TempThird, &value);
}

int
addWrite_Mirror_TempThird(int16_t value)
{
	return addWrite(ID_Mirror_TempThird, &value);
}

int
getStatus_Mirror_TempThird(void)
{
	return getStatus(ID_Mirror_TempThird);
}

int
doWrite_Mirror_TempFourth(int16_t value)
{
	return doWrite(ID_Mirror_TempFourth, &value);
}

int
addWrite_Mirror_TempFourth(int16_t value)
{
	return addWrite(ID_Mirror_TempFourth, &value);
}

int
getStatus_Mirror_TempFourth(void)
{
	return getStatus(ID_Mirror_TempFourth);
}

int
doWrite_C_Mirror_Temp(int16_t value)
{
	return doWrite(ID_C_Mirror_Temp, &value);
}

int
addWrite_C_Mirror_Temp(int16_t value)
{
	return addWrite(ID_C_Mirror_Temp, &value);
}

int
getStatus_C_Mirror_Temp(void)
{
	return getStatus(ID_C_Mirror_Temp);
}

int
doWrite_C_Mirror_HR(u_int16_t value)
{
	return doWrite(ID_C_Mirror_HR, &value);
}

int
addWrite_C_Mirror_HR(u_int16_t value)
{
	return addWrite(ID_C_Mirror_HR, &value);
}

int
getStatus_C_Mirror_HR(void)
{
	return getStatus(ID_C_Mirror_HR);
}

int
doWrite_C_Mirror_CO2_ppm(u_int16_t value)
{
	return doWrite(ID_C_Mirror_CO2_ppm, &value);
}

int
addWrite_C_Mirror_CO2_ppm(u_int16_t value)
{
	return addWrite(ID_C_Mirror_CO2_ppm, &value);
}

int
getStatus_C_Mirror_CO2_ppm(void)
{
	return getStatus(ID_C_Mirror_CO2_ppm);
}

int
doWrite_C_Mirror_O3(u_int16_t value)
{
	return doWrite(ID_C_Mirror_O3, &value);
}

int
addWrite_C_Mirror_O3(u_int16_t value)
{
	return addWrite(ID_C_Mirror_O3, &value);
}

int
getStatus_C_Mirror_O3(void)
{
	return getStatus(ID_C_Mirror_O3);
}

int
doWrite_C_Mirror_VOC(u_int16_t value)
{
	return doWrite(ID_C_Mirror_VOC, &value);
}

int
addWrite_C_Mirror_VOC(u_int16_t value)
{
	return addWrite(ID_C_Mirror_VOC, &value);
}

int
getStatus_C_Mirror_VOC(void)
{
	return getStatus(ID_C_Mirror_VOC);
}

int
doWrite_C_Mirror_C_PM2_5(u_int16_t value)
{
	return doWrite(ID_C_Mirror_C_PM2_5, &value);
}

int
addWrite_C_Mirror_C_PM2_5(u_int16_t value)
{
	return addWrite(ID_C_Mirror_C_PM2_5, &value);
}

int
getStatus_C_Mirror_C_PM2_5(void)
{
	return getStatus(ID_C_Mirror_C_PM2_5);
}

int
doWrite_CommandCO2(u_int16_t value)
{
	return doWrite(ID_CommandCO2, &value);
}

int
addWrite_CommandCO2(u_int16_t value)
{
	return addWrite(ID_CommandCO2, &value);
}

int
getStatus_CommandCO2(void)
{
	return getStatus(ID_CommandCO2);
}
...
update_all(void)
{
	...
	retval += readFromDb(ID_TCP_RTU, &TCP_RTU);
	retval += readFromDb(ID_RTU_Temp, &RTU_Temp);
	retval += readFromDb(ID_RTU_HR, &RTU_HR);
	retval += readFromDb(ID_RTU_CO2_ppm, &RTU_CO2_ppm);
	retval += readFromDb(ID_RTU_O3, &RTU_O3);
	retval += readFromDb(ID_RTU_VOC, &RTU_VOC);
	retval += readFromDb(ID_RTU_C_PM1_0, &RTU_C_PM1_0);
	retval += readFromDb(ID_RTU_C_PM2_5, &RTU_C_PM2_5);
	retval += readFromDb(ID_RTU_C_PM4_0, &RTU_C_PM4_0);
	retval += readFromDb(ID_RTU_C_PM10, &RTU_C_PM10);
	retval += readFromDb(ID_C_BitMaskLoT1, &C_BitMaskLoT1);
	retval += readFromDb(ID_C_itMaskLoHR1, &C_itMaskLoHR1);
	retval += readFromDb(ID_C_BitMaskLoCO21, &C_BitMaskLoCO21);
	retval += readFromDb(ID_C_BitMaskLoO31, &C_BitMaskLoO31);
	retval += readFromDb(ID_C_BitMaskLoVOC1, &C_BitMaskLoVOC1);
	retval += readFromDb(ID_C_BitMaskLoPM251, &C_BitMaskLoPM251);
	retval += readFromDb(ID_C_BitMaskLoCH41, &C_BitMaskLoCH41);
	retval += readFromDb(ID_C_BitMaskHi1, &C_BitMaskHi1);
	retval += readFromDb(ID_C_HeartBeatLo, &C_HeartBeatLo);
	retval += readFromDb(ID_C_READS, &C_READS);
	retval += readFromDb(ID_Mirror_Temp, &Mirror_Temp);
	retval += readFromDb(ID_Mirror_HR, &Mirror_HR);
	retval += readFromDb(ID_Mirror_CO2_ppm, &Mirror_CO2_ppm);
	retval += readFromDb(ID_Mirror_O3, &Mirror_O3);
	retval += readFromDb(ID_Mirror_VOC, &Mirror_VOC);
	retval += readFromDb(ID_Mirror_C_PM2_5, &Mirror_C_PM2_5);
	retval += readFromDb(ID_Mirror_CH4, &Mirror_CH4);
	retval += readFromDb(ID_Mirror_TempFirst, &Mirror_TempFirst);
	retval += readFromDb(ID_Mirror_TempSecond, &Mirror_TempSecond);
	retval += readFromDb(ID_Mirror_TempThird, &Mirror_TempThird);
	retval += readFromDb(ID_Mirror_TempFourth, &Mirror_TempFourth);
	retval += readFromDb(ID_C_Mirror_Temp, &C_Mirror_Temp);
	retval += readFromDb(ID_C_Mirror_HR, &C_Mirror_HR);
	retval += readFromDb(ID_C_Mirror_CO2_ppm, &C_Mirror_CO2_ppm);
	retval += readFromDb(ID_C_Mirror_O3, &C_Mirror_O3);
	retval += readFromDb(ID_C_Mirror_VOC, &C_Mirror_VOC);
	retval += readFromDb(ID_C_Mirror_C_PM2_5, &C_Mirror_C_PM2_5);
	retval += readFromDb(ID_CommandCO2, &CommandCO2);
