...
#define ID_TCP_RTU 2
extern u_int16_t TCP_RTU;
int doWrite_TCP_RTU(u_int16_t value);
int addWrite_TCP_RTU(u_int16_t value);
int getStatus_TCP_RTU(void);

#define ID_RTU_Temp 225
extern int16_t RTU_Temp;	/* Sensor temperature in °C */
int doWrite_RTU_Temp(int16_t value);
int addWrite_RTU_Temp(int16_t value);
int getStatus_RTU_Temp(void);

#define ID_RTU_HR 226
extern u_int16_t RTU_HR;	/* Relative Humidity in % */
int doWrite_RTU_HR(u_int16_t value);
int addWrite_RTU_HR(u_int16_t value);
int getStatus_RTU_HR(void);

#define ID_RTU_CO2_ppm 227
extern u_int16_t RTU_CO2_ppm;	/* ppm Co2 concentration */
int doWrite_RTU_CO2_ppm(u_int16_t value);
int addWrite_RTU_CO2_ppm(u_int16_t value);
int getStatus_RTU_CO2_ppm(void);

#define ID_RTU_O3 228
extern u_int16_t RTU_O3;	/* Part per billion O3 concentration */
int doWrite_RTU_O3(u_int16_t value);
int addWrite_RTU_O3(u_int16_t value);
int getStatus_RTU_O3(void);

#define ID_RTU_VOC 229
extern u_int16_t RTU_VOC;	/* VOC measure */
int doWrite_RTU_VOC(u_int16_t value);
int addWrite_RTU_VOC(u_int16_t value);
int getStatus_RTU_VOC(void);

#define ID_RTU_C_PM1_0 230
extern u_int16_t RTU_C_PM1_0;	/* PM 1.0 ug-m3  range 0-1000 */
int doWrite_RTU_C_PM1_0(u_int16_t value);
int addWrite_RTU_C_PM1_0(u_int16_t value);
int getStatus_RTU_C_PM1_0(void);

#define ID_RTU_C_PM2_5 231
extern u_int16_t RTU_C_PM2_5;	/* PM 2.5 ug-m3  range 0-1000 */
int doWrite_RTU_C_PM2_5(u_int16_t value);
int addWrite_RTU_C_PM2_5(u_int16_t value);
int getStatus_RTU_C_PM2_5(void);

#define ID_RTU_C_PM4_0 232
extern u_int16_t RTU_C_PM4_0;	/* PM 4.0 ug-m3  range 0-1000 */
int doWrite_RTU_C_PM4_0(u_int16_t value);
int addWrite_RTU_C_PM4_0(u_int16_t value);
int getStatus_RTU_C_PM4_0(void);

#define ID_RTU_C_PM10 233
extern u_int16_t RTU_C_PM10;	/* PM 10 ug-m3  range 0-1000 */
int doWrite_RTU_C_PM10(u_int16_t value);
int addWrite_RTU_C_PM10(u_int16_t value);
int getStatus_RTU_C_PM10(void);

#define ID_C_BitMaskLoT1 276
extern int C_BitMaskLoT1;	/* Low part bitmask */
int doWrite_C_BitMaskLoT1(int value);
int addWrite_C_BitMaskLoT1(int value);
int getStatus_C_BitMaskLoT1(void);

#define ID_C_itMaskLoHR1 277
extern int C_itMaskLoHR1;	/* Low part bitmask */
int doWrite_C_itMaskLoHR1(int value);
int addWrite_C_itMaskLoHR1(int value);
int getStatus_C_itMaskLoHR1(void);

#define ID_C_BitMaskLoCO21 278
extern int C_BitMaskLoCO21;	/* Low part bitmask */
int doWrite_C_BitMaskLoCO21(int value);
int addWrite_C_BitMaskLoCO21(int value);
int getStatus_C_BitMaskLoCO21(void);

#define ID_C_BitMaskLoO31 279
extern int C_BitMaskLoO31;	/* Low part bitmask */
int doWrite_C_BitMaskLoO31(int value);
int addWrite_C_BitMaskLoO31(int value);
int getStatus_C_BitMaskLoO31(void);

#define ID_C_BitMaskLoVOC1 280
extern int C_BitMaskLoVOC1;	/* Low part bitmask */
int doWrite_C_BitMaskLoVOC1(int value);
int addWrite_C_BitMaskLoVOC1(int value);
int getStatus_C_BitMaskLoVOC1(void);

#define ID_C_BitMaskLoPM251 281
extern int C_BitMaskLoPM251;	/* Low part bitmask */
int doWrite_C_BitMaskLoPM251(int value);
int addWrite_C_BitMaskLoPM251(int value);
int getStatus_C_BitMaskLoPM251(void);

#define ID_C_BitMaskLoCH41 282
extern int C_BitMaskLoCH41;	/* Low part bitmask */
int doWrite_C_BitMaskLoCH41(int value);
int addWrite_C_BitMaskLoCH41(int value);
int getStatus_C_BitMaskLoCH41(void);

#define ID_C_BitMaskHi1 283
extern u_int16_t C_BitMaskHi1;	/* Hi part bitmask */
int doWrite_C_BitMaskHi1(u_int16_t value);
int addWrite_C_BitMaskHi1(u_int16_t value);
int getStatus_C_BitMaskHi1(void);

#define ID_C_HeartBeatLo 284
extern u_int16_t C_HeartBeatLo;	/* Heart beat low part update each 100ms */
int doWrite_C_HeartBeatLo(u_int16_t value);
int addWrite_C_HeartBeatLo(u_int16_t value);
int getStatus_C_HeartBeatLo(void);

#define ID_C_READS 285
extern u_int32_t C_READS;	/* Heart beat low part update each 100ms */
int doWrite_C_READS(u_int32_t value);
int addWrite_C_READS(u_int32_t value);
int getStatus_C_READS(void);

#define ID_Mirror_Temp 286
extern int16_t Mirror_Temp;	/* Sensor temperature in °C */
int doWrite_Mirror_Temp(int16_t value);
int addWrite_Mirror_Temp(int16_t value);
int getStatus_Mirror_Temp(void);

#define ID_Mirror_HR 287
extern u_int16_t Mirror_HR;	/* Relative Humidity in % */
int doWrite_Mirror_HR(u_int16_t value);
int addWrite_Mirror_HR(u_int16_t value);
int getStatus_Mirror_HR(void);

#define ID_Mirror_CO2_ppm 288
extern u_int16_t Mirror_CO2_ppm;	/* ppm Co2 concentration */
int doWrite_Mirror_CO2_ppm(u_int16_t value);
int addWrite_Mirror_CO2_ppm(u_int16_t value);
int getStatus_Mirror_CO2_ppm(void);

#define ID_Mirror_O3 289
extern u_int16_t Mirror_O3;	/* Part per billion O3 concentration */
int doWrite_Mirror_O3(u_int16_t value);
int addWrite_Mirror_O3(u_int16_t value);
int getStatus_Mirror_O3(void);

#define ID_Mirror_VOC 290
extern u_int16_t Mirror_VOC;	/* VOC measure */
int doWrite_Mirror_VOC(u_int16_t value);
int addWrite_Mirror_VOC(u_int16_t value);
int getStatus_Mirror_VOC(void);

#define ID_Mirror_C_PM2_5 291
extern u_int16_t Mirror_C_PM2_5;	/* PM 2.5 ug-m3  range 0-1000 */
int doWrite_Mirror_C_PM2_5(u_int16_t value);
int addWrite_Mirror_C_PM2_5(u_int16_t value);
int getStatus_Mirror_C_PM2_5(void);

#define ID_Mirror_CH4 292
extern u_int16_t Mirror_CH4;	/* Average partcle diameter */
int doWrite_Mirror_CH4(u_int16_t value);
int addWrite_Mirror_CH4(u_int16_t value);
int getStatus_Mirror_CH4(void);

#define ID_Mirror_TempFirst 293
extern int16_t Mirror_TempFirst;
int doWrite_Mirror_TempFirst(int16_t value);
int addWrite_Mirror_TempFirst(int16_t value);
int getStatus_Mirror_TempFirst(void);

#define ID_Mirror_TempSecond 294
extern int16_t Mirror_TempSecond;
int doWrite_Mirror_TempSecond(int16_t value);
int addWrite_Mirror_TempSecond(int16_t value);
int getStatus_Mirror_TempSecond(void);

#define ID_Mirror_TempThird 295
extern int16_t Mirror_TempThird;
int doWrite_Mirror_TempThird(int16_t value);
int addWrite_Mirror_TempThird(int16_t value);
int getStatus_Mirror_TempThird(void);

#define ID_Mirror_TempFourth 296
extern int16_t Mirror_TempFourth;
int doWrite_Mirror_TempFourth(int16_t value);
int addWrite_Mirror_TempFourth(int16_t value);
int getStatus_Mirror_TempFourth(void);

#define ID_C_Mirror_Temp 297
extern int16_t C_Mirror_Temp;	/* Sensor temperature in °C */
int doWrite_C_Mirror_Temp(int16_t value);
int addWrite_C_Mirror_Temp(int16_t value);
int getStatus_C_Mirror_Temp(void);

#define ID_C_Mirror_HR 298
extern u_int16_t C_Mirror_HR;	/* Relative Humidity in % */
int doWrite_C_Mirror_HR(u_int16_t value);
int addWrite_C_Mirror_HR(u_int16_t value);
int getStatus_C_Mirror_HR(void);

#define ID_C_Mirror_CO2_ppm 299
extern u_int16_t C_Mirror_CO2_ppm;	/* ppm Co2 concentration */
int doWrite_C_Mirror_CO2_ppm(u_int16_t value);
int addWrite_C_Mirror_CO2_ppm(u_int16_t value);
int getStatus_C_Mirror_CO2_ppm(void);

#define ID_C_Mirror_O3 300
extern u_int16_t C_Mirror_O3;	/* Part per billion O3 concentration */
int doWrite_C_Mirror_O3(u_int16_t value);
int addWrite_C_Mirror_O3(u_int16_t value);
int getStatus_C_Mirror_O3(void);

#define ID_C_Mirror_VOC 301
extern u_int16_t C_Mirror_VOC;	/* VOC measure */
int doWrite_C_Mirror_VOC(u_int16_t value);
int addWrite_C_Mirror_VOC(u_int16_t value);
int getStatus_C_Mirror_VOC(void);

#define ID_C_Mirror_C_PM2_5 302
extern u_int16_t C_Mirror_C_PM2_5;	/* PM 2.5 ug-m3  range 0-1000 */
int doWrite_C_Mirror_C_PM2_5(u_int16_t value);
int addWrite_C_Mirror_C_PM2_5(u_int16_t value);
int getStatus_C_Mirror_C_PM2_5(void);

#define ID_CommandCO2 303
extern u_int16_t CommandCO2;	/* PM 2.5 ug-m3  range 0-1000 */
int doWrite_CommandCO2(u_int16_t value);
int addWrite_CommandCO2(u_int16_t value);
int getStatus_CommandCO2(void);
